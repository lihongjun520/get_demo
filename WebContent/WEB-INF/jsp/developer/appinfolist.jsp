...
<div class="row">
	<div class="col-md-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<form method="post" action="${pageContext.request.contextPath }/dev/appinfo/list">
					<input type="hidden" name="pageIndex" value="${pages.currPage}" />
			    <ul>
					<li>
				...
				<div class="row">
					<div class="col-sm-5">
						<div class="dataTables_info" id="datatable-responsive_info"
							...
							${pages.currPage }/${pages.totalPageCount }页</div>
					</div>
					<div class="col-sm-7">
							...
							<ul class="pagination">
								<c:if test="${pages.currPage > 1}">
									...
									<li class="paginate_button "><a
										href="javascript:page_nav(document.forms[0],${pages.currPage-1});"
										aria-controls="datatable-responsive" data-dt-idx="1"
										tabindex="0">上一页</a>
									</li>
								</c:if>
								<c:if test="${pages.currPage < pages.totalPageCount }">
									<li class="paginate_button "><a
										href="javascript:page_nav(document.forms[0],${pages.currPage+1 });"
										aria-controls="datatable-responsive" data-dt-idx="1"
										tabindex="0">下一页</a>
